...
public class IHMFahrenheit extends JFrame implements ActionListener{
  ...
  public void actionPerformed( ActionEvent ae ){
    try{
      ...
      try{fahrenheit = Integer.parseInt(entree.getText().toString());
        }catch(NumberFormatException nfe){
            System.out.println("error !" +nfe.getMessage());
            
        }
      float celsius = ((int)(question2.FahrenheitCelsius.fahrenheitEnCelsius(fahrenheit)*10))/10.0F; // à compléter, en appelant la méthode ad'hoc de la question2 
